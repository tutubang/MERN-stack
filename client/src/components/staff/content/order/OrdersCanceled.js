...
class OrdersCanceled extends Component {
    constructor(props) {
        super(props);
        this.state = {
            length: 0,
        ...
        this.getOrdersCanceled = this.getOrdersCanceled.bind(this);
    ...
    render() {
        return (
            <div>
                <p className="alert alert-info">Total {this.state.length} orders Canceled!</p>
                <input
                    type="text"
