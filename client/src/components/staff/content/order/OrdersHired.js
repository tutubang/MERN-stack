...
class OrdersHired extends Component {
    constructor(props) {
        super(props);
        this.state = {
            length: 0,
        ...
        this.getOrdersHired = this.getOrdersHired.bind(this);
    ...
    render() {
        return (
            <div>
                <p className="alert alert-info">Total {this.state.length} orders Hired!</p>
                <input
                    type="text"
