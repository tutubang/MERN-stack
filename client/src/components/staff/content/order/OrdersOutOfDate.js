...
class OrdersOutOfDate extends Component {
    constructor(props) {
        super(props);
        this.state = {
            length: 0,
        ...
        this.getOrdersOutOfDate = this.getOrdersOutOfDate.bind(this);
    ...
    render() {
        return (
            <div>
                <p className="alert alert-info">Total {this.state.length} orders Out of date!</p>
                <input
                    type="text"
                                    ...
                                    <tbody key={order._id}>
                                        <tr>
                                            ...
                                            <td><button
                                                ...
                                                value={order._id}>Check out</button>                                         
                                            </td>
                                        </tr>
                                    </tbody>
                                )
...
export default OrdersOutOfDate;